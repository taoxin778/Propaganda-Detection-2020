...
from utils_ner import read_preproces_data, read_and_convert_data, get_labels, get_propgranda_span
try:
...
def main():
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        output_test_predictions_file = os.path.join(args.output_dir, "roberta_01.txt")
